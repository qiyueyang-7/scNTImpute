...
parser.add_argument('--n-epochs', type=int, default=4, help='Number of epochs to train')
parser.add_argument('--eval-every', type=int, default=4, help='Number of epochs between loggings')
