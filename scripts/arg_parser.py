...
parser.add_argument('--n-epochs', type=int, default=2000, help='Number of epochs to train')
parser.add_argument('--eval-every', type=int, default=200, help='Number of epochs between loggings')
...
parser.add_argument('--dataset-str', type=str, default='mouse', help='dataset name. Must be the key of available_datasets')
parser.add_argument('--target-dataset-str', type=str, default='mouse', help='target dataset name. Must be the key of available_datasets')
