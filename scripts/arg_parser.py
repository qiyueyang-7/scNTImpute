...
# Model parameters
parser.add_argument('--model', type=str, default='scNTImpute', help="model name")
parser.add_argument('--device', type=str, default='cpu', help="device to hold the model")
...
parser.add_argument('--dthre', type=float, default=0.9, help="Threshold of gene undetected rate")
...
parser.add_argument('--n-epochs', type=int, default=100, help='Number of epochs to train')
parser.add_argument('--eval-every', type=int, default=20, help='Number of epochs between loggings')
...
parser.add_argument('--dataset-str', type=str, default='demo', help='dataset name. Must be the key of available_datasets')
parser.add_argument('--target-dataset-str', type=str, default='demo', help='target dataset name. Must be the key of available_datasets')
