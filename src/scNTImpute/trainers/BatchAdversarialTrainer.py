...
from scNTImpute.models import BaseCellModel, BatchClassifier
...
class BatchAdversarialTrainer(UnsupervisedTrainer):
    ...
    def __init__(self,
        ...
        lr_decay: float = 5e-5,
        batch_size: int = 2000,
        train_instance_name: str = "scNTImputebatch",
        restore_epoch: int = 0,
        seed: int = -1,
    ...
    def train(self,
        ...
        **train_kwargs
        ...
        See `UnsupervisedTrainer.tr
        ain` for common argument docstrings.
        ...
        Args:
            ...
            g_steps: times to update scNTImpute in a training step.
